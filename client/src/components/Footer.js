...
const Footer = () => {
  return (
    <div className=" w-full  bg-gradient-to-r from-cyan-50 via-blue to-cyan-50">
  ...
  <div class="container mx-auto px-4">
    ...
    <hr class="my-6 border-red-800"/>
    <div class="flex flex-wrap items-center md:justify-between justify-center">
      <div class="w-full md:w-4/12 px-4 mx-auto text-center">
        <div class="text-sm text-blueGray-500 font-semibold py-1">DR. DENNIS
        </div>
      </div>
    </div>
    </footer>
